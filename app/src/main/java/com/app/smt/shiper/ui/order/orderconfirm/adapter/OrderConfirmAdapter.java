package com.app.smt.shiper.ui.order.orderconfirm.adapter;
...
public class OrderConfirmAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private OrderConfirmAdapter.OrderAdapterListener mListener;
    private Context mContext;

    public OrderConfirmAdapter(Context context, OrderConfirmAdapter.OrderAdapterListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OrderConfirmAdapter.ViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder,int position) {
        final OrderConfirmAdapter.ViewHolder viewHolder = (OrderConfirmAdapter.ViewHolder) holder;
        ...
        viewHolder.mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.onConfirmOrderSuccess(holder.getAdapterPosition(), mListData.get(holder.getAdapterPosition()));
            }
        });
        viewHolder.mBtnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onConfirmOrderFail(holder.getAdapterPosition(), mListData.get(holder.getAdapterPosition()));
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.view_old_price)
        View mViewPriceOld;

        @BindView(R.id.tv_price_value_2)
        TextView mTvPriceOld;

        @BindView(R.id.tv_price_unit_2)
        TextView mTvPriceUnitOld;
        ...
        public void bind(Order order, int index) {
            ...
            mBtnOK.setText(mContext.getResources().getString(R.string.btn_confirm_ok));
            mBtnCancel.setText(mContext.getResources().getString(R.string.btn_confirm_cancel));
            ...
            if (AppConstants.CHANGE_MONEY.equals(order.getSaleOrderInformationCommon().getChangeType())) {
                mViewPriceOld.setVisibility(View.VISIBLE);
                int old = order.getSaleOrderInformationCommon().getFeeShip() + order.getReasonChangeMoney().getOldMoney();
                mTvPriceOld.setText(FilterNumberString.filterMoney(  old + ""));
                mBtnStatus.setText(mContext.getResources().getString(R.string.confirm_status_money));
            } else {
                mViewPriceOld.setVisibility(View.GONE);
                mBtnStatus.setText(mContext.getResources().getString(R.string.confirm_status_ship));
            }
    ...
    public interface OrderAdapterListener {
        ...
        void onConfirmOrderSuccess(int index, Order order);
        void onConfirmOrderFail(int index, Order order);
    }
}