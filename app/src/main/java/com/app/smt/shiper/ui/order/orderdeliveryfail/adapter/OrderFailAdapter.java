package com.app.smt.shiper.ui.order.orderdeliveryfail.adapter;
...
public class OrderFailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Order> mListData;
    private OrderFailAdapter.OrderAdapterListener mListener;
    private Context mContext;

    public OrderFailAdapter(Context context, OrderFailAdapter.OrderAdapterListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OrderFailAdapter.ViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder,int position) {
        final OrderFailAdapter.ViewHolder viewHolder = (OrderFailAdapter.ViewHolder) holder;
        ...
        viewHolder.mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.onClickMoveDelevering(holder.getAdapterPosition(), mListData.get(holder.getAdapterPosition()));
            }
        });
    ...
    public interface OrderAdapterListener {
        ...
        void onClickMoveDelevering(int index, Order order);
    }
}