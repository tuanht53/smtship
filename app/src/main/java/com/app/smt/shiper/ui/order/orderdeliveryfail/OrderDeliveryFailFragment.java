...
import com.app.smt.shiper.ui.order.orderdeliveryfail.adapter.OrderFailAdapter;
...
public class OrderDeliveryFailFragment extends BaseFragment implements OrderDeliveryFailMvpView, OrderFailAdapter.OrderAdapterListener,
        StoreOptionAdapter.StoreOptionAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    public static final String TAG = OrderDeliveryFailFragment.class.getSimpleName();

    @Inject
    OrderDeliveryFailPresenter mPresenter;
    ...
    private OrderFailAdapter mAdapter;
    ...
    public OrderDeliveryFailFragment() {
        // Required empty public constructor
    }

    public static OrderDeliveryFailFragment newInstance(String param1, String param2) {
        OrderDeliveryFailFragment fragment = new OrderDeliveryFailFragment();
    ...
    protected void setUp(View view) {
        ...
        mAdapter = new OrderFailAdapter(getBaseActivity(), this);
    ...
    public void onMessageEvent(String message) {
        if (AppConstants.EVENTBUS_LIST_ORDER_FAIL.equals(message)) {
            fetchData(1, true);
        }
    }
    ...
    @Override
    public void onClickMoveDelevering(int index, Order order) {
        mPresenter.apiOrderMoveDelevering(index, order.getTxtId());
    }
